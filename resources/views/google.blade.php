	...
	$(document).ready(function(){
		...
		$('.test').on('click',function (e) {
			...
			$.ajax({
				...
				type:'post',
				data:{_token:Dcat.token,google:$("input[name='google']").val(),onecode:$("input[name='onecode']").val()},
		...
		$('.success').on('click',function (e) {
			...
			$.ajax({
				...
				type:'post',
                data:{_token:Dcat.token,google:$("input[name='google']").val(),onecode:$("input[name='onecode']").val(),is_open_google_auth:$('#ga-enable').val()},
				success:function (obj) {
					console.log(obj);
